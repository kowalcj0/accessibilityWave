...
public class LocalWebDriverListener implements IInvokedMethodListener {
    ...
    public void beforeInvocation(IInvokedMethod method, ITestResult testResult) {
        log.debug("BEGINNING: org.kowalcj0.accessibilityWave.LocalWebDriverListener.beforeInvocation");
    ...
    public void afterInvocation(IInvokedMethod method, ITestResult testResult) {
        log.debug("BEGINNING: org.kowalcj0.accessibilityWave.LocalWebDriverListener.afterInvocation");
        if (method.isTestMethod()) {
            try {
        ...
        log.debug("END: org.kowalcj0.accessibilityWave.LocalWebDriverListener.afterInvocation");
    }
}